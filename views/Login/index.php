...
<body class="body-login">
    <div class="container-login">
        ...
        <main class="logar-formulario">
            <div class="infoSistema">
                        <h2 class="titulo-infoSistema">SuperVisor</h2>
                        <br>
                        <p class="paragrafo-infoSistema">
                            Encontre professores com interesses em comum, descubra a orientação ideal e envie solicitações de estágio com facilidade.
                        <br>
                        </p>
                        <p class="paragrafo-infoSistema">
                            <strong>Tudo isso em um só lugar:</strong> simples, rápido e feito para você crescer no <strong>IFRS</strong>.  

</p>
                </div>
                <form method="POST" action="index.php" enctype="multipart/form-data" class="itens-formulario-logar">
